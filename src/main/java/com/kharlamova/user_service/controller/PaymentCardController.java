...
public class PaymentCardController {
    ...
    @PreAuthorize("hasRole('ADMIN') or #paymentCardDto.userId == authentication.principal.userId")
    @PostMapping
    ...
    @PreAuthorize("hasRole('ADMIN') or #cardDto.userId == authentication.principal.userId")
